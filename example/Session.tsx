...
function Session() {
    ...
    async function initializeMaster() {
        const decryptedResponse = decryptValue(window.location.pathname.split("/")[1])
        ...
        */
        ...
        setVideoLabel(kinesisClient.localStream.getVideoTracks()[0].label) /*optional*/
        setAudioLabel(kinesisClient.localStream.getAudioTracks()[0].label) /*optional*/
        /*get channle arn*/
    ...
    return (
        <div id="sessionContent">
            ...
            <div className="sessionLabel">
                <div style={{ color: '#D1D5DB', fontSize: '13px' }}>Camera: {videoLabel}</div>
                <div style={{ color: '#D1D5DB', fontSize: '13px' }}>Audio: {audionLabel}</div>
            </div>
            {/*remote*/}
            ...
            {/*
              ...
              - Inline css
            */}
            {alert && <div className="sessionAlert">
