  ...
  return (
    <div>
      ...
      <div style={{ color: "#6B7280", marginBottom: "1rem" }}>
        Share this link to others so they can join this meeting.{" "}
        <span style={{ fontWeight: "bold" }}>Maximum 10</span> people
      </div>
      <div
        style={{
          display: "flex",
      ...
      >
        ...
        >
          <svg
            ...
            height="24"
            viewBox="0 0 24 24"
            style={{ fill: "#3B82F6", transform: "-ms-filter" }}
          >
      ...
      <div style={{ fontSize: "13px", marginTop: "1rem" }}>{today}</div>
    </div>
  );
}
