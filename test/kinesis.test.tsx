...
it("it should throw and error when access key is empty", () => {
    ...
    expect(() => new KinesisClient(testConfig)).toThrow('Access key id cannot be empty');
})

it("it should throw and error when secret access key is empty", () => {
    testConfig.secretAccessKey = ""
    expect(() => new KinesisClient(testConfig)).toThrow('Secret access key cannot be empty');
})
